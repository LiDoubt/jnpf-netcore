...
using JNPF.WorkFlow.Entitys.Dto.WorkFlowForm.DocumentApproval;
...
    /// </summary>
    ...
    public class DocumentApprovalService : IDocumentApprovalService, IDynamicApiController, ITransient
    {
        ...
        public DocumentApprovalService(ISqlSugarRepository<DocumentApprovalEntity> sqlSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        {
            var data = (await _sqlSugarRepository.FirstOrDefaultAsync(x => x.Id == id)).Adapt<DocumentApprovalInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, DocumentApprovalEntity entity)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<DocumentApprovalUpInput>(), 0, 0, true);
                #endregion
