...
    /// </summary>
    ...
    public class SalesOrderService : ISalesOrderService, IDynamicApiController, ITransient
    {
        ...
        public SalesOrderService(ISqlSugarRepository<SalesOrderEntity> sqlSugarRepository, ISqlSugarRepository<SalesOrderEntryEntity> sqlItemSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        public async Task<dynamic> GetInfo(string id)
        {
            ...
            data.entryList = (await _sqlItemSugarRepository.Entities.Where(x => x.SalesOrderId == id).ToListAsync()).Adapt<List<EntryListItem>>();
            return data;
        }
        #endregion
        ...
        public async Task Save([FromBody] SalesOrderCrInput input)
        {
            ...
            {
                await Submit(entity.Id, entity, entityList);
            }
        ...
        /// <param name="itemList"></param>
        /// <returns></returns>
        private async Task Submit(string id, SalesOrderEntity entity, List<SalesOrderEntryEntity> itemList)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<SalesOrderUpInput>(), 0, 0, true);
                #endregion
