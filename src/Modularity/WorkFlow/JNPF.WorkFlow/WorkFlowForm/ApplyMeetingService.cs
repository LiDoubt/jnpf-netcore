...
using JNPF.WorkFlow.Entitys.Dto.WorkFlowForm.ApplyMeeting;
...
    /// </summary>
    ...
    public class ApplyMeetingService : IApplyMeetingService, IDynamicApiController, ITransient
    {
        ...
        public ApplyMeetingService(ISqlSugarRepository<ApplyMeetingEntity> sqlSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        {
            var data = (await _sqlSugarRepository.FirstOrDefaultAsync(x => x.Id == id)).Adapt<ApplyMeetingInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, ApplyMeetingEntity entity)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<ApplyMeetingUpInput>(), 0, 0, true);
                #endregion
