...
using JNPF.WorkFlow.Entitys.Dto.WorkFlowForm.SupplementCard;
...
    /// </summary>
    ...
    public class SupplementCardService : ISupplementCardService, IDynamicApiController, ITransient
    {
        ...
        public SupplementCardService(ISqlSugarRepository<SupplementCardEntity> sqlSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        {
            var data = (await _sqlSugarRepository.FirstOrDefaultAsync(x => x.Id == id)).Adapt<SupplementCardInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, SupplementCardEntity entity)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<SupplementCardUpInput>(), 0, 0, true);
                #endregion
