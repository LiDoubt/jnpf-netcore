...
using JNPF.WorkFlow.Entitys.Dto.WorkFlowForm.ExpenseExpenditure;
...
    /// </summary>
    ...
    public class ExpenseExpenditureService : IExpenseExpenditureService, IDynamicApiController, ITransient
    {
        ...
        public ExpenseExpenditureService(ISqlSugarRepository<ExpenseExpenditureEntity> sqlSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        {
            var data = (await _sqlSugarRepository.FirstOrDefaultAsync(x => x.Id == id)).Adapt<ExpenseExpenditureInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, ExpenseExpenditureEntity entity)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<ExpenseExpenditureUpInput>(), 0, 0, true);
                #endregion
