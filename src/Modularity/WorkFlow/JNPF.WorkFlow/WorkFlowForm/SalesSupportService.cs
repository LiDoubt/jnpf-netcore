...
using JNPF.WorkFlow.Entitys.Dto.WorkFlowForm.SalesSupport;
...
    /// </summary>
    ...
    public class SalesSupportService : ISalesSupportService, IDynamicApiController, ITransient
    {
        ...
        public SalesSupportService(ISqlSugarRepository<SalesSupportEntity> sqlSugarRepository, IBillRullService billRuleService, IFlowTaskService flowTaskService)
        {
        ...
        {
            var data = (await _sqlSugarRepository.FirstOrDefaultAsync(x => x.Id == id)).Adapt<SalesSupportInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, SalesSupportEntity entity)
        {
            try
            {
                DbScoped.SugarScope.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<SalesSupportUpInput>(), 0, 0, true);
                #endregion
